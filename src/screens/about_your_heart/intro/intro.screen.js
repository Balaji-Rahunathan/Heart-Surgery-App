    ...
    return (
      <React.Fragment>
        ...
        <div className="about_your_heart_container text-center mt-5">
          ...
          <h3 className="head-title" style={{ padding: "10px 60px" }}>
            ...
            {this.state.para ? (
              <div className="para_text" style={{ textAlign: "left" }}>
                <span className="btn-text">
                  ...
                  takes a vein from your leg and an artery from your chest wall
                  or arm. These are used to bypass the narrowed area in your
                  coronary arteries. This improves the oxygen supply to the
                  heart muscle. Your body can still work without the arteries
                  and veins that are used by the surgeon for your bypass.{" "}
                </span>
              </div>
            ) : null}
          </div>
