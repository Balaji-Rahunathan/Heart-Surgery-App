        ...
        <div className="fyandyp_screen">
            <div className="fyandyp_container">
                <div className="fyandyp_wrapper">
                    ...
                    <div className="fyandyp_title_container">
                        <p className="fyandyp_title_text">Managing your feelings as you recover</p>
                    </div>
                    ...
                    <div className="fyandyp_sub_content_container">
                        <div className="fyandup_sub_content_head_container">
                            <p className="fyandup_sub_content_head_text">Try to balance your feelings by:</p>
                        </div>
                        <div className="fyandup_sub_content_title_container">
                            <p className="fyandup_sub_content_title_text">1. Getting involved in your medical treatment:</p>
                        </div>
                        <div className="fyandup_sub_content_container">
                            <p className="fyandup_sub_content_text">
                                Ask questions about your condition and
                                your recovery. Decide to make your lifestyle healthier.
                                </p>
                        </div>

                        <div className="fyandup_sub_content_title_container">
                            <p className="fyandup_sub_content_title_text">2. Involve your partner, family and friends:</p>
                        </div>
                        <div className="fyandup_sub_content_container">
                            <p className="fyandup_sub_content_text">
                                Talk to them. If you explain your feelings,
                                people will be in a better position to
                                support you when you need support, give
                                you “space” when you need space and
                                understand what’s going on with you.
                                </p>
                        </div>

                        <div className="fyandup_sub_content_title_container">
                            <p className="fyandup_sub_content_title_text">3. Regain your social life as much as possible:</p>
                        </div>
                        <div className="fyandup_sub_content_container">
                            <p className="fyandup_sub_content_text">
                                Friends can be a great support. They can
                                help you return to normal and lend a
                                listening ear outside of the home.
                                </p>
                        </div>
                    </div>
                    ...
                    <div className="fyandyp_image_content_container">
                        <p className="fyandyp_image_content_text">
                            Depression is common after heart
                            surgery, especially if you have been
                            troubled by depression before. It is
                            normal to experience good days and bad
                            days as you recover. On a bad day you
                            may have to push your- self to get out of
                            bed and be tearful. You may avoid
                            meeting people and may not feel like
                            talking with friends. These feelings
                            are common but for most people, only
                            temporary. Push yourself a little if you feel
                            this way. Tell your family exactly how you
                            are feeling. If you feel this way
                            continuously for three to four weeks, you
                            may be depressed. Please see your GP as
                            you may need a short course of treatment.
                            You can also contact your local cardiac
                            rehabilitation team for follow up advice
                            and counselling.
                            </p>
                    </div>
