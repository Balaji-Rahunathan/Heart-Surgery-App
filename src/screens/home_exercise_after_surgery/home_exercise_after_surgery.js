        ...
        <Container className="swiper_container">
          ...
          <div className="heas_wrapper">
            <div className="heas_body_container" id="body">
              ...
              <div className="heas_content_container">
                <p className="heas_content_text">
                  People with heart problems are often unsure about how fast
                  they should walk, or how hard they can exercise. The Borg
                  Scale is one way to track how hard you are working by asking
              ...
              <div className="heas_bottom_body_container">
                <div className="heas_bottom_body_head">
                  <p className="heas_bottom_body_head_text">Borg Scale</p>
                </div>
