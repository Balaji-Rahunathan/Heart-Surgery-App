    ...
    <div className="page_one_screen">
      ...
      <Container className="swiper_container">
        ...
        <div className="slider_container">
          ...
          >
            <div className="pos_sub_title_text" style={{
              fontWeight: "600",
              fontSize: "24px",
              color: "#00a1fb",
              padding: '0.8em 50px'
            }}>High cholesterol</div>
          </div>
          <div
...
<div
        ...
        <div className="slider_container">
          ...
          <div className="pos_content_container">
            <p className="pos_content_text">
              ...
              build up plaque in the body’s arteries. High levels can increase
              your risk of heart disease.
            </p>
            <p className="pos_content_text">
              High density lipoproteins (HDL – or good cholesterol). HDL helps
              to remove cholesterol, and slows down the build up of plaque in
              the body’s arteries. Higher levels protect against heart disease.
            </p>
          </div>
          <div
            className="pos_bold_text_container"
          ...
          <div className="pos_content_container">
            ...
            <p className="pos_content_text blue-clrr">
              The goal is to have a low total cholesterol level, a low level of
        ...
        <div className="slider_container">
          ...
          <div className="pts_content_container">
            <p className="pts_content_text">
              The blood test to check your cholesterol, LDL cholesterol, HDL
              cholesterol and triglycerides is called a lipoprotein profile. The
              test is most accurate when taken after you have fasted for 12
              hours (e.g. overnight). Speak to your cardiologist before leaving
              hospital to find out what YOUR cholesterol goal is.
            </p>
          </div>
        ...
        <div className="blue-clr">
            ...
            <div className="pts_content_container">
              <p className="pts_content_text">
                Every three months until you reach your goal, and yearly after
                that. Talk to your GP.
              </p>
            </div>
          </div>
        ...
        <div className="slider_container">
          ...
          >
            <p className="pts_content_text">
              ...
              stanols / sterols (e.g. Benecol®, Flora-Pro-Active ®, and
              Danacol®). These products, when taken with a healthy diet and
              regular exercise can reduce cholesterol a little more. The amount
              that needs to be taken for this effect is one bottle of the
              yoghurt drinks every day (Benecol®, Flora-Pro-Active ®, and
              Danacol®) or two to three servings of the spreads, milks or
              cheeses every day.
            </p>
          </div>
