      ...
      <Container className="swiper_container">
        ...
        <div className="slider_container">
          ...
          <div className="pths_content_container">
            ...
            <p className="pths_content_text">
              Fish is a great substitute for red meat, and is our main source of
              omega 3, which protects your heart. Adults should eat at least two
              140g portions of fish per week. At least one of these portions
              should be oily fish e.g. salmon, mackerel, herring, trout,
              sardines, kippers and fresh tuna. Some omega 3 is also found in
              walnuts, pecans, peanuts, almonds, and flaxseed (ground linseed).
              Omega 3 supplements are not recommended even if you don’t eat
              fish!
            </p>
          </div>
        </div>
        ...
        <div className="slider_container">
          ...
          <div className="pths_content_container">
            ...
            <p className="pths_content_text">
              ...
              antioxidants. These vitamins help prevent plaque from building up
              in the walls of arteries and protect you from further heart
              problems. Fruit and vegetables are also high in fibre, which can
            ...
            <p className="pths_content_text" style={{ paddingTop: "1em" }}>
              ...
              vegetables a day. Frozen are as good as fresh. We don’t recommend
              taking nutritional supplements instead of eating fruit and
              vegetables.
            </p>
          </div>
        </div>
        ...
        <div className="slider_container">
          ...
          <div className="pths_content_container">
            ...
            <p className="pths_content_text">
              Reducing the amount of fat you eat is important to lose weight.
              Eating less saturated fat can help to reduce cholesterol and slow
              plaque build-up in the wall of the blood vessels. Some tips:
            </p>
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> High fat
              foods include cream, full-fat cheese, butter, cakes, pastries,
              chocolate, crisps, mayonnaise and salad dressings.
            </p>
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> Look out
              for lower fat dairy products i.e. low fat milk, cheese and
              yoghurts.
            </p>
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> Use low fat
              spreads; if using oils use rapeseed or olive oil.
            </p>
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> Trim fat
              from meat.
            </p>
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> Avoid fried
              or deep fried foods, fast food and take-aways.
            </p>
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> Good ways
              to cook are to grill, casserole, roast, poach, braise, microwave
              or stir-fry.
            </p>
          </div>
        </div>
        ...
        <div className="slider_container">
          ...
          >
            ...
            <p className="pths_content_text">
              ...
              foods marketed as “low fat”. Limit unnecessary sugar e.g. in tea,
              coffee, cereals, sugar coated cereals, biscuits, regular fizzy
              drinks and confec- tionaries. Sweeteners are a safe substitute but
              honey is as fattening as sugar!
            </p>
          </div>
        </div>
        <div className="slider_container" style={{ paddingTop: "2em" }}>
          ...
          <div className="pths_content_container" style={{ marginTop: "1em" }}>
            ...
            <p className="pths_content_text">
              Soluble fibre found in oats, pulses and some fruit and vegetables
              can help to lower your blood cholesterol level.
            </p>
            <p className="pths_content_text">
            ...
            <p className="pths_content_text">
              <FiberManualRecordIcon style={{ fontSize: "10px" }} /> High fibre
              breakfast cereals such as porridge, oat flakes and ‘no added
              sugar’ muesli are an excellent source of fibre.
            </p>
            <p className="pths_content_text">
        ...
        <div className="slider_container" style={{ paddingTop: "2em" }}>
          ...
          >
            ...
            <p className="pths_content_text">
              Do not add salt to your food. Replace salt with pepper, herbs and
              spices. Try to avoid foods that are high in salt like packet soups
              and bacon.
            </p>
          </div>
        </div>
