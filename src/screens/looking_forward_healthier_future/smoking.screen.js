        ...
        {load && (
          <>
            <div className="slider_container">
              ...
              <div className="pos_points_container">
                <p className="pos_pionts_text">
                  ...
                  coronary artery disease. The longer and heavier one smokes,
                  the higher the risk for both.
                </p>
                <p className="pos_pionts_text">
                ...
                <p className="pos_pionts_text">
                  5. Smoking makes the blood more prone to clotting in the
                  coronary arteries, and elsewhere. This increases your risk of
                  stroke and heart attack.
                </p>

                <p className="pos_pionts_text">
                  6. A smoker’s heart has to work harder by pumping faster, just
                  to deliver the same amount of oxygen all over the body. This
              ...
              <div className="pos_points_container">
                <p className="pos_pionts_text">
                  ...
                  stopping. They usually last 3 to 5 minutes and then start to
                  wear off.
                </p>
              </div>
            </div>
            ...
            <div className="slider_container">
              ...
              <div className="pos_points_container">
                <p className="pos_pionts_text">
                  1. <span className="pos_bold_d">D</span>elay at least 3
                  minutes and the urge will pass.
                </p>
                <p className="pos_pionts_text">
                  2. <span className="pos_bold_d">D</span>istract yourself -
                  move away from the situation.
                </p>
                <p className="pos_pionts_text">
                  3. <span className="pos_bold_d">D</span>eep breathe – slowly
                  and deeply.
                </p>
                <p className="pos_pionts_text">
                  4. <span className="pos_bold_d">D</span>rink a glass of water
                  or fruit juice.
                </p>
              </div>
            </div>
            ...
            <div className="slider_container">
              ...
              <div className="pos_content_container">
                <p className="pos_content_text">
                  Oxygen levels in the blood return to normal. Chances of a
                  heart attack start to fall.
                </p>
              </div>
            </div>
            ...
            <div className="slider_container">
              ...
              <div className="pos_content_container">
                <p className="pos_content_text">
                  Carbon monoxide is eliminated from the body. The lungs start
                  to clear out mucous and other debris.
                </p>
              </div>
              <div className="pos_time_period_container">
              ...
              <div className="pos_content_container">
                <p className="pos_content_text">
                  Nicotine is no longer detectable in the body. The ability to
                  taste and smell is improved.
                </p>
              </div>
              <div className="pos_time_period_container">
            ...
            <div className="slider_container">
              ...
              <div className="pos_content_container">
                <p className="pos_content_text">
                  Breathing problems such as cough, shortness of breath, and
                  wheeze decrease. Overall, lung function improves by 5 to 10%.
                </p>
              </div>
              <div className="pos_time_period_container">
            ...
            <div className="slider_container">
              ...
              <div className="pos_content_container">
                <p className="pos_content_text">
                  If you are quitting smoking, the more support you have the
                  more likely you are to succeed. NRT (patches, gum, inhaler,
                  lozenges, microtabs and oral spray) can help smokers stop by
                  reducing withdrawal symptoms and cravings. It is not a magic
                  cure but it will support you in your decision to stop smoking.
                  NRT usually provides nicotine in a way which is slower and
                  less satisfying, but safer and less addictive than cigarettes.
                </p>
                <p
                  className="pos_content_text blue-clro"
                  style={{ paddingTop: "2em" }}
                >
                  NRT is available to medical card holders, and without
                  prescription for everyone, from your pharmacist. For further
                  information and advice talk to your doctor, GP or pharmacist.
                  Medications to help you stop smoking (Varenicline and
                  Bupropion) are available on prescription from your doctor.
                </p>
              </div>
            ...
            <div className="slider_container" style={{position: 'relative'}}>
              ...
              >
                <p className="pos_bold_text">
                  A free smoking cessation service is available for those who
                  would like to quit. For one to one or group support:
                </p>
              </div>
              <div className="pos_content_container">
                <p className="pos_content_text">
                  <FiberManualRecordIcon className="pos_points_icon" /> Call 1
