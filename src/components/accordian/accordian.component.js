      ...
      <div className="content_container">
        <div className="table_container">
          ...
          <div className="table_row scale-0">
            <div className="scale scale-0">0</div>
            <div className="accordian_container scale-0">
              <div class="accordion scale-0">
                No Excertion
                <ExpandMoreIcon className="accordian_icon" />
              </div>
              <div class="panel scale-0">
                No exertion is how you feel when you’re sitting or lying down.
              </div>
            </div>
          </div>

          <div className="table_row scale-1">
            <div className="scale scale-1">1</div>
            <div className="accordian_container scale-1">
              <div class="accordion scale-1">
          ...
          <div className="table_row scale-2-3">
            <div className="scale scale-2-3">2-3</div>
            <div className="accordian_container scale-2-3">
              <div class="accordion scale-2-3">
          ...
          <div className="table_row scale-4-6">
            <div className="scale scale-4-6">4-6</div>
            <div className="accordian_container scale-4-6">
              <div class="accordion scale-4-6">
                Somewhat hard{" "}
                <ExpandMoreIcon className="accordian_icon" />
              </div>
              <div class="panel scale-4-6">
                ...
                recommended intensity for the main part of exercise, as it
                brings the best benefits at the lowest risk.
              </div>
            </div>
          </div>

          <div className="table_row scale-7-8">
            <div className="scale scale-7-8">7-8</div>
            <div className="accordian_container scale-7-8">
              <div class="accordion scale-7-8">
                Hard (Heavy){" "}
                <ExpandMoreIcon className="accordian_icon" />
              </div>
          ...
          <div className="table_row scale-9">
            <div className="scale scale-9">9</div>
            <div className="accordian_container scale-9">
              <div class="accordion scale-9">
          ...
          <div className="table_row scale-10">
            <div className="scale scale-10">10</div>
            <div className="accordian_container scale-10">
              <div class="accordion scale-10">
                Maximal exertion{" "}
                <ExpandMoreIcon className="accordian_icon" />
              </div>
